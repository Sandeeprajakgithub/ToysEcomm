    ...
    <% if(email == "null"){ %>
        ...
        <div class="container-md border">
            ...
            <div class="row mt-2">
                ...
                <div class="col-md-4 text-center m-1 p-1">
                    <img src="images/10.jpg" height="80px">
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing.</p>
                    <br>
                    <img src="images/11.jpg" height="80px">
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing.</p>
                </div>
                <div class="col-md-4 text-center m-1 p-1">
                    <img src="images/12.jpg" height="80px">
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing.</p>
                    <br>
                    <img src="images/13.jpg" height="80px">
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing.</p>
                </div>
            </div>
    ...
    <% } else { %>
        ...
        <% if(email.equals("sandeeprajakjbp2002@gmail.com")){ %>
           <%-- <h1>welcome malik</h1> --%>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-4 text-center m-1 p-1">
                                <div class="col-md-4 text-center m-1 p-1">
                                    ...
                                    <a href='showproduct.do?TAG=0'>Show products</a>
                                </div> 
                            </div>
                        </div>
                    </div>
            ...
            <script>
                ...
                var a = document.getElementById('a14');
                var i = 61 ;
                var product_image = document.getElementById('add_product');
        ...
        <% } else { %>
            <div class="container-md border">
                ...
                <input type="button" id="btn_pro" value="show products">
